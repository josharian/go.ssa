...
func rewriteValueAMD64(v *Value, config *Config) bool {
	...
	case OpAdd16:
		...
		// result: (MOVWQSX (ADDW <v.Type> x y))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64ADDW, TypeInvalid)
			v0.Type = v.Type
			v0.AddArg(x)
			v0.AddArg(y)
			v.AddArg(v0)
	...
	case OpAdd32:
		...
		// result: (MOVLQSX (ADDL <v.Type> x y))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64ADDL, TypeInvalid)
			v0.Type = v.Type
			v0.AddArg(x)
			v0.AddArg(y)
			v.AddArg(v0)
	...
	case OpAdd8:
		...
		// result: (MOVBQSX (ADDB <v.Type> x y))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64ADDB, TypeInvalid)
			v0.Type = v.Type
			v0.AddArg(x)
			v0.AddArg(y)
			v.AddArg(v0)
	...
	end32ef1328af280ac18fa8045a3502dae9:
		...
		// result: (InvertFlags (CMPQconst <TypeFlags> x [c]))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64CMPQconst, TypeInvalid)
			v0.Type = TypeFlags
			v0.AddArg(x)
			v0.AuxInt = c
			v.AddArg(v0)
	...
	case OpEq64:
		...
		// result: (SETEQ (CMPQ <TypeFlags> x y))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64CMPQ, TypeInvalid)
			v0.Type = TypeFlags
			v0.AddArg(x)
			v0.AddArg(y)
			v.AddArg(v0)
	...
	case OpIsNonNil:
		...
		// result: (SETNE (TESTQ <TypeFlags> p p))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64TESTQ, TypeInvalid)
			v0.Type = TypeFlags
			v0.AddArg(p)
			v0.AddArg(p)
			v.AddArg(v0)
	...
	case OpLsh64:
		...
		// result: (ANDQ (SHLQ <t> x y) (SBBQcarrymask <t> (CMPQconst <TypeFlags> [64] y)))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64SHLQ, TypeInvalid)
			v0.Type = t
			v0.AddArg(x)
			v0.AddArg(y)
			v.AddArg(v0)
			v1 := v.Block.NewValue0(v.N, OpAMD64SBBQcarrymask, TypeInvalid)
			v1.Type = t
			v2 := v.Block.NewValue0(v.N, OpAMD64CMPQconst, TypeInvalid)
			v2.Type = TypeFlags
			v2.AuxInt = 64
			v2.AddArg(y)
			v1.AddArg(v2)
	...
	case OpMove:
		...
		// result: (REPMOVSB dst src (Const <TypeUInt64> [size]) mem)
		{
			...
			v.AddArg(dst)
			v.AddArg(src)
			v0 := v.Block.NewValue0(v.N, OpConst, TypeInvalid)
			v0.Type = TypeUInt64
			v0.AuxInt = size
			v.AddArg(v0)
			v.AddArg(mem)
	...
	case OpNeg16:
		...
		// result: (MOVWQSX (NEGW <v.Type> x))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64NEGW, TypeInvalid)
			v0.Type = v.Type
			v0.AddArg(x)
			v.AddArg(v0)
			return true
	...
	case OpNeg32:
		...
		// result: (MOVLQSX (NEGL <v.Type> x))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64NEGL, TypeInvalid)
			v0.Type = v.Type
			v0.AddArg(x)
			v.AddArg(v0)
			return true
	...
	case OpNeg8:
		...
		// result: (MOVBQSX (NEGB <v.Type> x))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64NEGB, TypeInvalid)
			v0.Type = v.Type
			v0.AddArg(x)
			v.AddArg(v0)
			return true
	...
	case OpRsh64:
		...
		// result: (SARQ <t> x (CMOVQCC <t> 			(CMPQconst <TypeFlags> [64] y) 			(Const <t> [63]) 			y))
		{
			...
			v.Type = t
			v.AddArg(x)
			v0 := v.Block.NewValue0(v.N, OpAMD64CMOVQCC, TypeInvalid)
			v0.Type = t
			v1 := v.Block.NewValue0(v.N, OpAMD64CMPQconst, TypeInvalid)
			v1.Type = TypeFlags
			v1.AuxInt = 64
			v1.AddArg(y)
			v0.AddArg(v1)
			v2 := v.Block.NewValue0(v.N, OpConst, TypeInvalid)
			v2.Type = t
			v2.AuxInt = 63
			v0.AddArg(v2)
			v0.AddArg(y)
	...
	case OpRsh64U:
		...
		// result: (ANDQ (SHRQ <t> x y) (SBBQcarrymask <t> (CMPQconst <TypeFlags> [64] y)))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64SHRQ, TypeInvalid)
			v0.Type = t
			v0.AddArg(x)
			v0.AddArg(y)
			v.AddArg(v0)
	...
	end5a74a63bd9ad15437717c6df3b25eebb:
		...
		// result: (NEGQ (SUBQconst <t> x [c]))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64SUBQconst, TypeInvalid)
			v0.Type = t
			v0.AddArg(x)
			v0.AuxInt = c
			v.AddArg(v0)
	...
	case OpSub16:
		...
		// result: (MOVWQSX (SUBW <v.Type> x y))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64SUBW, TypeInvalid)
			v0.Type = v.Type
			v0.AddArg(x)
			v0.AddArg(y)
			v.AddArg(v0)
	...
	case OpSub32:
		...
		// result: (MOVLQSX (SUBL <v.Type> x y))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64SUBL, TypeInvalid)
			v0.Type = v.Type
			v0.AddArg(x)
			v0.AddArg(y)
			v.AddArg(v0)
	...
	case OpSub8:
		...
		// result: (MOVBQSX (SUBB <v.Type> x y))
		{
			...
			v.Aux = nil
			v.resetArgs()
			v0 := v.Block.NewValue0(v.N, OpAMD64SUBB, TypeInvalid)
			v0.Type = v.Type
			v0.AddArg(x)
			v0.AddArg(y)
			v.AddArg(v0)
	...
	endf0a22f1506977610ac0a310eee152075:
		...
		// result: (Zero [size%8] (OffPtr <TypeUInt64> [size-(size%8)] destptr) (REPSTOSQ  <TypeMem> destptr (Const <TypeUInt64> [size/8]) mem))
		{
			...
			v0.AddArg(destptr)
			v.AddArg(v0)
			v1 := v.Block.NewValue0(v.N, OpAMD64REPSTOSQ, TypeInvalid)
			v1.Type = TypeMem
			v1.AddArg(destptr)
			v2 := v.Block.NewValue0(v.N, OpConst, TypeInvalid)
			v2.Type = TypeUInt64
...
func rewriteBlockAMD64(b *Block) bool {
	...
	end04935012db9defeafceef8175f803ea2:
		...
		// result: (NE (TESTB <TypeFlags> cond cond) yes no)
		{
			...
			b.Kind = BlockAMD64NE
			v0 := v.Block.NewValue0(v.N, OpAMD64TESTB, TypeInvalid)
			v0.Type = TypeFlags
			v0.AddArg(cond)
			v0.AddArg(cond)
			b.Control = v0
